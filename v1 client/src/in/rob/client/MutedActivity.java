...
import in.rob.client.page.MutedPage;
 ...
 */
public class MutedActivity extends RobinSlidingActivity
{
	...
	@Override public void setup(boolean isPhone)
	{
		...
		bundle1.putString(Constants.EXTRA_TITLE, getString(R.string.muted_users));
		pages.put(MutedPage.class, bundle1);
