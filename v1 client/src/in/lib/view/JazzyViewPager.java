...
public class JazzyViewPager extends ViewPager {
	...
	private TransitionEffect mEffect = TransitionEffect.Tablet;

	public final HashMap<Integer, Object> mObjs = new LinkedHashMap<Integer, Object>();

	private static final float SCALE_MAX = 0.2f;
	private static final float ZOOM_MAX = 0.2f;
	private static final float ROT_MAX = 7.0f;
...
//		mRight = getChildAt(position+1);
	...
	private View findViewFromObject(int position) {
		...
		for (int i = 0; i < getChildCount(); i++) {
			v = getChildAt(i);
			if (o != null && a.isViewFromObject(v, o))
				return v;
		}
		return null;
	}
