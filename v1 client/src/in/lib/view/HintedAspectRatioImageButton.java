 ...
 */
public class HintedAspectRatioImageButton extends AspectRatioImageButton implements OnLongClickListener
{
	private OnLongClickListener mOnLongClickListener;

	public HintedAspectRatioImageButton(Context context)
	{
		super(context);
		setOnLongClickListener(this);
	}

	public HintedAspectRatioImageButton(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		setOnLongClickListener(this);
	}
