...
public class BitmapUtils
{
	 ...
	 * @return The scale size of the image to use with {@link android.graphics.BitmapFactory.Options}
	 */
	...
	/**
	 * Recursivly samples an image to below or equal the max width/height
	 * @param fd The path to the image
	 * @param maxWidth The maximum width the image can be
	 * @param maxHeight The maximum height the image can be
	 * @return The scale size of the image to use with {@link android.graphics.BitmapFactory.Options}
	 */
	 ...
	 * @param currentOrientation The current orientation as discripted in {@link android.media.ExifInterface}
